...
public class User {
	...
	public boolean checkFirstName(String firstname) {
		...
		// System.out.println("(It should be in format of 'First name starts with Cap
	...
	public boolean checkemail(String email) {
		...
		// System.out.println("(Email has 3 mandatory parts (abc, bl& co) and 2 optional
		// (xyz & in) with\r\n"
	...
	public boolean checkpassword(String password) {
		...
		// System.out.println("(It should be in format of 'minimum 8 Characters and
		// Should have at least Upper Case \r\n"
		// + "Should have at least 1 numeric number in the password and has 1 special
		// character '");
	...
	public boolean checkmobileno(String mobile) {
		...
		// System.out.println("(It should be in format of 'Mobile Format - E.g.
		// +919919819801\r\n"
